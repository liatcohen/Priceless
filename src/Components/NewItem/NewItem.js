      ...
      return (
         <div>
            ...
            <div className="NewItem">
               ...
               <div><input name="city" type="text" placeholder={store.city} value={store.city} onChange={this.inputHandler} /></div>
               <div><input name="venue" type="text" placeholder="Venue" value={store.venue} onChange={this.inputHandler} /></div>
               <div><input name="asked_price" type="Number" placeholder="Asked price" value={store.asked_price} onChange={this.inputHandler} /></div>
               <div><input name="original_price" type="Number" placeholder="Original price" value={store.original_price} onChange={this.inputHandler} /></div>
