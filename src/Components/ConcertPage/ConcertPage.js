   ...
   render() {
      ...
      return (
         <div className="concertSection">
            ...
            <div className="concertPhoto" style={{backgroundImage: "url(" + this.props.ConcertStore.concert.img_url + ")" , backgroundSize: "51.2vw 22vw",   marginRight: "14.5%"  }}></div>
            ...
            <div className="ticketSection">
               ...
               <div className="info">
                  ...
                  <div className="iconBar"><i class="fas fa-check-circle iconConcert"></i> 44% Saving</div>
